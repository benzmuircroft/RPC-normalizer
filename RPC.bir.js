...
var RPC=module.exports={
    daemon:' BIR.cli -datadir=/home/BIR/data'
,   exec:function(cmd){
...
,   signmessage:function(addr,msg,pw,keepopen){
        /*
        signmessage "BIRaddress" "message"

        Sign a message with the private key of an address
        Requires wallet passphrase to be set with walletpassphrase call.

        Arguments:
        1. "BIRaddress"  (string, required) The BIR address to use for the private key.
        ...
        > birake-cli walletpassphrase "mypassphrase" 30

        Create the signature
        > birake-cli signmessage "DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6" "my message"

        Verify the signature
        > birake-cli verifymessage "DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6" "signature" "my message"

        As json rpc
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "signmessage", "params": ["DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6", "my message"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   gettransaction:function(txid){
        ...
        Result:
        {
          "amount" : x.xxx,        (numeric) The transaction amount in BIR
          ...
          "details" : [
            {
              "account" : "accountname",  (string) DEPRECATED.This field will be removed in v5.0. To see this deprecated field, start biraked with -deprecatedrpc=accounts. The account name involved in the transaction, can be "" for the default account.
              "address" : "BIRaddress",   (string) The BIR address involved in the transaction
              "category" : "send|receive",    (string) The category, either 'send' or 'receive'
              "amount" : x.xxx                  (numeric) The amount in BIR
        ...
        Examples:
        > birake-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"
        > birake-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" true
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "gettransaction", "params": ["1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
...
,   decoderawtransaction:function(hex,txid){
        ...
        Result:
        {
          ...
          "vout" : [             (array of json objects)
             {
               "value" : x.xxx,            (numeric) The value in BIR
               "n" : n,                    (numeric) index
               "scriptPubKey" : {          (json object)
                 ...
                 "addresses" : [           (json array of string)
                   "12tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc"   (string) BIR address
                   ,...
                 ]
               }
             }
        ...
        Examples:
        > birake-cli decoderawtransaction "hexstring"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "decoderawtransaction", "params": ["hexstring"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
...
,   gettxout:function(txid,vout,addr,pw){
        ...
        Result:
        {
          ...
          "confirmations" : n,       (numeric) The number of confirmations
          "value" : x.xxx,           (numeric) The transaction value in BIR
          "scriptPubKey" : {         (json object)
             "asm" : "code",       (string)
             "hex" : "hex",        (string)
             "reqSigs" : n,          (numeric) Number of required signatures
             "type" : "pubkeyhash", (string) The type, eg pubkeyhash
             "addresses" : [          (array of string) array of BIR addresses
             "BIRaddress"            (string) BIR address
                ,...
             ]
          },
        ...
        > birake-cli listunspent

        View the details
        > birake-cli gettxout "txid" 1

        As a json rpc call
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "gettxout", "params": ["txid", 1] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
...
,   getblock:function(hash){
        ...
        Examples:
        > birake-cli getblock "00000000000fd08c2fb661d2fcb0d49abb3a91e5f27082ce64feed3b4dede2e2"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getblock", "params": ["00000000000fd08c2fb661d2fcb0d49abb3a91e5f27082ce64feed3b4dede2e2"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   getchaintip:function(){
        ...
        Examples
        > birake-cli getbestblockhash
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getbestblockhash", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   getblockcount:function(){
        ...
        Examples:
        > birake-cli getblockcount
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getblockcount", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   walletlock:function(p){
        ...
        This is needed prior to performing transactions related to private keys such as sending BIRs
        ...
        > birake-cli walletpassphrase "my pass phrase" 60

        Unlock the wallet for 60 seconds but allow staking only
        > birake-cli walletpassphrase "my pass phrase" 60 true

        Lock the wallet again (before 60 seconds)
        > birake-cli walletlock

        As json rpc call
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "walletpassphrase", "params": ["my pass phrase", 60] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   listunspent:function(address,min_confirmations){
        ...
        3. "addresses"    (string) A json array of BIR addresses to filter
            [
              "address"   (string) BIR address
              ,...
            ]
        ...
        [                   (array of json object)
          {
            ...
            "vout" : n,               (numeric) the vout value
            "address" : "address",  (string) the BIR address
            "label" : "label",      (string) The associated label, or "" for the default label
            "account" : "account",  (string) DEPRECATED.This field will be removed in v5.0. To see this deprecated field, start biraked with -deprecatedrpc=accounts. Backwards compatible alias for label.
        ...
        Examples
        > birake-cli listunspent
        > birake-cli listunspent 6 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "listunspent", "params": [6, 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   createrawtransaction:function(inputs,outputs){
        ...
        2. "addresses"           (string, required) a json object with addresses as keys and amounts as values
            {
              "address": x.xxx   (numeric, required) The key is the BIR address, the value is the BIR amount
              ,...
            }
        ...
        Examples
        > birake-cli createrawtransaction "[{\"txid\":\"myid\",\"vout\":0}]" "{\"address\":0.01}"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "createrawtransaction", "params": ["[{\"txid\":\"myid\",\"vout\":0}]", "{\"address\":0.01}"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
        if(RPC.mode!=='test'){
...
,   signrawtransaction:function(hex){
        ...
        Examples:
        > birake-cli signrawtransaction "myhex"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "signrawtransaction", "params": ["myhex"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
        if(RPC.mode!=='test'){
...
,   sendrawtransaction:function(hex){
        ...
        > birake-cli createrawtransaction "[{\"txid\" : \"mytxid\",\"vout\":0}]" "{\"myaddress\":0.01}"
        Sign the transaction, and get back the hex
        > birake-cli signrawtransaction "myhex"

        Send the transaction (signed hex)
        > birake-cli sendrawtransaction "signedhex"

        As a json rpc call
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "sendrawtransaction", "params": ["signedhex"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
        if(RPC.mode!=='test'){
...
,   lockunspent:function(unlock,txid,vout){
        ...
        A locked transaction output will not be chosen by automatic coin selection, when spending BIRs.
        ...
        > birake-cli lockunspent false "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"

        List the locked transactions
        > birake-cli listlockunspent

        Unlock the transaction again
        > birake-cli lockunspent true "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"

        As a json rpc call
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "lockunspent", "params": [false, "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
...
,   estimatefee:function(blocks){
        ...
        Result:
        {
          ...
          "subversion": "/Birake:x.x.x.x/",     (string) the server subversion string
          ...
          "relayfee": x.xxxxxxxx,                (numeric) minimum relay fee for non-free transactions in birake/kb
        ...
        Examples:
        > birake-cli getnetworkinfo
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getnetworkinfo", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   validateaddress:function(address){
        /*
        validateaddress "BIRaddress"

        Return information about the given BIR address.

        Arguments:
        1. "BIRaddress"     (string, required) The BIR address to validate

        Result:
        {
          "isvalid" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.
          "type" : "xxxx",              (string) "standard"
          "address" : "BIR address",    (string) The BIR address validated
        ...
        Examples:
        > birake-cli validateaddress "1PSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc"
        */
...
,   getnewaddress:function(){
        ...
        Returns a new BIR address for receiving payments.
        ...
        Result:
        "BIRaddress"    (string) The new BIR address

        Examples:
        > birake-cli getnewaddress
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getnewaddress", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        var o={r:{}};
        if(RPC.mode!=='test'){
...
,   dumpprivkey:function(address,pw){
        /*
        dumpprivkey "birakeaddress"

        Reveals the private key corresponding to 'birakeaddress'.
        Then the importprivkey can be used with this output

        Requires wallet passphrase to be set with walletpassphrase call.

        Arguments:
        1. "birakeaddress"   (string, required) The birake address for the private key

        Result:
        "key"                (string) The private key

        Examples:
        > birake-cli dumpprivkey "myaddress"
        > birake-cli importprivkey "mykey"
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "dumpprivkey", "params": ["myaddress"] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/

        importprivkey "birakeprivkey" ( "label" rescan fStakingAddress )
        ...
        Arguments:
        1. "birakeprivkey"      (string, required) The private key (see dumpprivkey)
        ...
        > birake-cli importprivkey "mykey" "testing" false

        As a JSON-RPC call
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "importprivkey", "params": ["mykey", "testing", false] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
...
,   getinfo:function(){
        ...
        Result:
        {
          ...
          "balance": xxxxxxx,           (numeric) the total BIR balance of the wallet (excluding zerocoins)
          ...
          "paytxfee": x.xxxx,           (numeric) the transaction fee set in BIR/kb
          "relayfee": x.xxxx,           (numeric) minimum relay fee for non-free transactions in BIR/kb
          "errors": "..."             (string) any error messages
        }

        Examples:
        > birake-cli getinfo
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getinfo", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        ...
        Examples:
        > birake-cli getblockchaininfo
        > curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getblockchaininfo", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:39698/
        */
        ...
        if(typeof o.r=='object'){
            o={
                e:  (['',null,undefined].indexOf(o.e)!==-1?undefined:o.e)
            ,   r:{
                    errors:                     o.r.warnings||w.r.errors||undefined//string
